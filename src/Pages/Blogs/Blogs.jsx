    ...
    return (
        <section className='grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-10 my-10'>
            <article className='shadow-md rounded-md'>
                <h2 className='text-lg text-white font-semibold bg-orange-500 p-5 rounded-md'>Compare SQL and NoSQL databases?</h2>
            ...
            <article className='shadow-md rounded-md'>
                <h2 className='text-lg text-white font-semibold bg-orange-500 p-5 rounded-md'>What is express js? What is Nest JS?</h2>
            ...
            <article className='shadow-md rounded-md'>
                <h2 className='text-lg text-white font-semibold bg-orange-500 p-5 rounded-md'>What is MongoDB aggregate and how does it work?</h2>
            ...
            <article className='shadow-md rounded-md'>
                <h2 className='text-lg text-white font-semibold bg-orange-500 p-5 rounded-md'>What is an access token and refresh token? How do they work and where should we store them on the client-side?</h2>
