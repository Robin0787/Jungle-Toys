    ...
    const menuItems = <>
        ...
        <NavLink className={({ isActive }) => isActive ? 'px-4 py-2 bg-gray-100 duration-300 rounded-md text-black' : "px-4 py-2 hover:bg-gray-100 duration-300 rounded-md"} to={'/all-toys'}>All Toys</NavLink>
        {
            user && <>
                ...
                <NavLink className={({ isActive }) => isActive ? 'px-4 py-2 bg-gray-100 duration-300 rounded-md text-black' : "px-4 py-2 hover:bg-gray-100 duration-300 rounded-md"} to={'/add-a-toy'}>Add A Toy</NavLink>
            </>
        }
        ...
        <div className="navbar bg-white rounded-b-md text-black">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow  rounded-box w-52 gap-4 bg-white text-black">
                        {menuItems}
                    </ul>
                </div>
            ...
            <div className="navbar-end">
                {
                    user ? <div className="dropdown dropdown-end">
                        ...
                        :
                        <Link to={'/login'} className='bg-orange-500 text-white px-6 py-2  rounded-sm'>Login</Link>
                }
            </div>
